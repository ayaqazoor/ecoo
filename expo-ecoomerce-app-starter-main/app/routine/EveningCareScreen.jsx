...
const EveningCareScreen = () => {
  ...
  const initialSteps = [
    { title: 'Remove Makeup 🧽', notes: [], input: '', showInput: false },
    { title: 'Cleanser 🧼', notes: [], input: '', showInput: false },
    { title: 'Toner 💧', notes: [], input: '', showInput: false },
    { title: 'Eye Cream 👁️', notes: [], input: '', showInput: false },
    { title: 'Night Cream 🌙', notes: [], input: '', showInput: false },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { backgroundColor: headerColor }]}>
        ...
        <Text style={styles.title}>Evening Care 🌙</Text>
        <View style={{ width: 28 }} />
      </View>
      ...
      >
        <View style={styles.modalBackground}>
          <View style={styles.modalContainer}>
            <Text style={styles.modalText}>مبروك خلصتي روتينك المسائي 🎉</Text>
...
export default EveningCareScreen;
